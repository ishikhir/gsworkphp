...
$stmt = $pdo->prepare("UPDATE user_table SET userId=:userId,userPass=:userPass2,name=:name,email=:email,zipCode=:zipCode,address1=:address1,address2=:address2 WHERE id=:id");
$stmt->bindValue(':id',$id,PDO::PARAM_INT);
$stmt->bindValue(':userId',$userId,PDO::PARAM_STR);
$stmt->bindValue(':userPass2',$userPass2,PDO::PARAM_STR);
